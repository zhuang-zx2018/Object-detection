...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'models/yolov5l.pt', help='initial weights path')
    ...
    parser.add_argument('--name', default='yolo5l', help='save to project/name')
