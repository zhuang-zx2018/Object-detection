...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/yolo5m9/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='night', help='save to project/name')
